...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <!-- Daqui em diante são slides adicionais -->
    ...
    <div class="item">
      <a href="eco.php"><img src="imagens/BANNERS/banner_eco.jpg" style="border-radius: 10px"></a>
    </div>

    <div class="item">
      <a href="missoes.php"><img src="imagens/BANNERS/banner_missoes.jpg" style="border-radius: 10px"></a>
    </div>

    <div class="item">
      <a href="ebd.php"><img src="imagens/BANNERS/banner_ebd.jpg" style="border-radius: 10px"></a>
    </div>
  </div>
...
<div style="background-color:#632731; color:#FFF; max-width: 100%;justify-content: flex-start;text-align: justify;text-justify: inter-word">
  <div style="padding: 1em 1em 1em 1em">
    <img src="imagens/icone_devocional.png"> Devocional da Semana
  </div>
  <!-- Título -->
  <div align="center"><h3>A cruz de Cristo é o ponto crucial para a mudança verdadeira <b>(Hebreus 4.14-16)</b></h3></div>
  <!-- Resumo -->
  <div style="padding: 1em 1em 1em 1em">
   Hoje, celebramos a ressureição de nosso Senhor e Salvador Jesus Cristo. A morte de Cristo, que parecia a maior derrota da fé, veio a ser maior vitória do cristianismo. Os cristãos hoje são conhecidos como o povo da cruz, do túmulo vazio e do Evangelho. O convite de Jesus para uma jornada de mudança. Mas a jornada começa num ponto crucial - a cruz. Esta mudança começa com o ser, não com o fazer. Descubramos duas razões pelas quais a cruz é o ponto crucial de toda mudança verdadeira.
