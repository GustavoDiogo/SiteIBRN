...
<body>
<font face="arial"> Se você tem fotos, vídeos ou algum outro material que possa ajudar a relembrarmos a nossa história, por favor, entre em contato conosco e nos ajude com esse projeto. Faça também seus comentários, elogios ou críticas. Retornaremos assim que possível.<br><br></font>
...
<!-- ATENÇÃO: O PARÂMETRO 'NAME' NECESSARIAMENTE DEVE TER O VALOR 'subject'. -->
 <input type=HIDDEN name="subject" value="Pagina 70 anos">
...
<!-- ATENÇÃO: O PARÂMETRO 'email' NECESSARIAMENTE DEVE TER O VALOR COM SEU E-MAIL@DOMINIOHOSPEDADO'. -->
 ...
 <tr>
  ...
  <td height="111" width="25%">Comentarios:</td>
  <td height="111" width="75%"><textarea name="comentarios" cols="40" rows="5"></textarea></td>
