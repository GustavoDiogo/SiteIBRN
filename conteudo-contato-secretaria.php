...
<body>
<font face="arial"> Faça seus suas solicitações para a secretaria, comentários, elogios ou críticas. <br>
...
<!-- ATENÇÃO: O PARÂMETRO 'NAME' NECESSARIAMENTE DEVE TER O VALOR 'subject'. -->
 <input type=HIDDEN name="subject" value="Pagina CONTATO SECRETARIA">
