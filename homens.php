...
include("menu-homens.php");?>
               ...
               <iframe name="alvo" height="410px" width="100%" frameborder="0" scrolling="yes" src="conteudo-homens-direita.php" id="theframe"></iframe>
               ...
               <?php
include("imagem-homens-direita.php");?>
